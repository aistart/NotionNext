  ...
  return <div className='flex flex-col transform hover:scale-105 duration-200 text-white text-center bg-indigo-700 rounded-full dark:bg-black cursor-pointer py-2.5'>
        ...
        {show && <>
            ...
            {BLOG.CONTACT_WEIXIN_E && <a target='_blank' rel='noreferrer' title={'企业微信'} href={BLOG.CONTACT_WEIXIN_E} >
                <i className='transform hover:scale-125 duration-150 fab fa-weixin ' />
            </a>}
            ...
            <i onClick={toggleShow} className='transform hover:scale-125 duration-150 fas fa-close' style={{ margin: '100px 0' }} />
