...
const BLOG = {
  ...
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://work.weixin.qq.com/kfid/kfcb8f0c45497ca5b6a', // 你的微博个人主页
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,email', 
