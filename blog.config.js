...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '投资日本房产正当时, 欢迎咨询投资日本房产事宜, 🎉アルファ未来株式会社',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'アルファ未来株式会社', // 您的昵称 例如 tangly1024github
  BIO: process.env.NEXT_PUBLIC_BIO || '华人投资日本房产的首选顾问', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://amirai.daoo.tech/about', // 网站地址
  ...
  POSTS_SHARE_SERVICES: process.env.NEXT_PUBLIC_POST_SHARE_SERVICES || 'link,wechat,email,qrcode', 
  ...
  // 所有支持的分享服务：link(复制链接),wechat(企业微信),qrcode(二维码),qq,weibo(微博),email(邮件),facebook,twitter,telegram,messenger,line,reddit,whatsapp,linkedin,vkshare,okshare,tumblr,livejournal,mailru,viber,workplace,pocket,instapaper,hatena
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '置业顾问', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '日本房产投资顾问', // 站点描述，被notion中的页面描述覆盖
